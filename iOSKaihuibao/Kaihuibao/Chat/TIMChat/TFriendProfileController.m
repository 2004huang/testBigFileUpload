...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (self.friendProfile.profile.faceURL) {
        [avatarView sd_setImageWithURL:[NSURL URLWithString:[NSString iconGetString:self.friendProfile.profile.faceURL]] placeholderImage:[UIImage imageNamed:TUIKitResource(@"default_head")]];
    } else {
