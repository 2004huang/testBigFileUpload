...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section
{
    ...
    if (self.profile.faceURL) {
        [avatarView sd_setImageWithURL:[NSURL URLWithString:[NSString iconGetString:self.profile.faceURL]] placeholderImage:[UIImage imageNamed:TUIKitResource(@"default_head")]  options:SDWebImageAllowInvalidSSLCertificates];
    } else {
