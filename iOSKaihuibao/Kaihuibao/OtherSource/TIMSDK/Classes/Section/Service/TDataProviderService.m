...
- (UIImageView *)getAvatarView:(TIMUserProfile *)profile
{
    ...
    [avatarView sd_setImageWithURL:[NSURL URLWithString:[NSString iconGetString:profile.faceURL]] placeholderImage:[UIImage imageNamed:TUIKitResource(@"default_head")] options:SDWebImageAllowInvalidSSLCertificates];
