...
//location cell
#define TLoactionMessageCell_ReuseId @"TLoactionMessageCell"
#define TLoactionMessageCell_Container_Size CGSizeMake((Screen_Width * 0.5), (Screen_Width * 0.35))
#define TLoactionMessageCell_Margin 10
#define TLoactionMessageCell_Progress_Color  RGBA(0, 0, 0, 0.5)
