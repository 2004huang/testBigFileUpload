...
- (void)setupViews
{
    ...
    [_recordButton setTitle:SIMLocalizedString(@"IMChatVoiceBtnPut", nil) forState:UIControlStateNormal];
...
- (void)talkDown:(UIButton *)sender
{
    ...
    [_recordButton setTitle:SIMLocalizedString(@"IMChatVoiceBtnOff", nil) forState:UIControlStateNormal];
    [self startRecord];
}
...
- (void)talkExit:(UIButton *)sender
{
    ...
    [_recordButton setTitle:SIMLocalizedString(@"IMChatVoiceBtnCancel", nil) forState:UIControlStateNormal];
}
