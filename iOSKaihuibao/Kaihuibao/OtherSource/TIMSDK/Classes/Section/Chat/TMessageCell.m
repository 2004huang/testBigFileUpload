...
- (void)setData:(TMessageCellData *)data
{
    ...
    if ([_data.head isEqualToString:TUIKitResource(@"default_head")]) {
        ...
        [_head sd_setImageWithURL:[NSURL URLWithString:[NSString iconGetString:data.head]] placeholderImage:[UIImage imageNamed:@"avatar"] options:SDWebImageAllowInvalidSSLCertificates];
    }
