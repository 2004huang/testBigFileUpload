...
@interface TGroupMembersView () <UISearchBarDelegate, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
@property (nonatomic, strong) NSMutableArray *data;
@end

@implementation TGroupMembersView
...
- (void)setupViews
{
    ...
    _searchBar.placeholder = SIMLocalizedString(@"CGSearchBarTitle", nil);
    ...
    [_collectionView registerClass:[TGroupMemberCell class] forCellWithReuseIdentifier:TGroupMemberCell_ReuseId];
